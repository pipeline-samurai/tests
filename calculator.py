...
if user_input3 is math_add:
    print(user_input1 + user_input2)
if user_input3 is math_substract:
    print(user_input1 - user_input2)
if user_input3 is math_multiply:
    print(user_input1 * user_input2)
if user_input3 is math_divide:
    print(user_input1 / user_input2)
if user_input3 is math_raise_to_power:
    print(user_input1^user_input2)
